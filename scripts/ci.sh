...
gate "release-build" bash -c "rm -rf release-output && npm run build && scripts/build-quirt-release.sh 6b4968e9443653af6636f2490bf3c4fc14da4cea 358516dd79dc18c2080b99779ce0b3e428fc9b63 release-output $SOURCE_EPOCH"
